...
actors = [
	...
	objects.Ammo(x=400, y=860, ammo={'minigun': 300, 'rifle': 120, 'rocket_gun': 15}),
	objects.GunsCase(x=224, y=969, guns=['minigun', 'rifle', 'shootgun', 'rocket_gun']),
	...
	objects.DoubleGunBonus(x=158, y=977, time=50000),
	...
	objects.TimeStopBonus(x=201, y=967, time=5000)
]
blocks = [
	level.Block(0,-40,'-'),
	level.Block(0,0,'-'),
