...
ais = [
	enemies.MeleeAI(x=3480, y=887),
	enemies.MeleeAI(x=4549, y=905),
	enemies.ShoterAI(x=5960, y=825, gun='rifle')
]
actors = [
	...
	objects.Text(x=99, y=768, text='Press A/D to move', size=30, color='white'),
	...
	objects.Text(x=1728, y=854, text='Press A/D when you`re on wall', size=30, color='white'),
	...
	objects.Image(x=6545, y=857, image='game/content/ui/arrow.png', rotation=-30, scale=1.0),
	objects.Ammo(x=5057, y=963, ammo={'rifle': 120}),
	objects.Trigger(x=0, y=612, w=400, h=400, function='game.player.ammo={}'),
	objects.LevelTravelTriger(x=6640, y=920, w=40, h=80, levelname='hook_tutor'),
	objects.ZoomTriger(x=11, y=974, w=400, h=40, zoom=0.65),
	objects.Text(x=6302, y=809, text='Use this portal to exit level', size=30, color='white'),
	objects.Text(x=6379, y=841, text='and save your progress', size=30, color='white'),
	objects.CameraTargetTriger(x=2908, y=803, w=40, h=200, target_x=3500, target_y=900, timer=3000),
	objects.Text(x=1768, y=894, text='and your mouse is opposite wall', size=30, color='white')
]
blocks = [
	level.Block(0,-40,'-'),
	level.Block(0,0,'-'),
	...
	level.Block(3800,680,'/'),
	level.Block(3800,640,'/'),
	level.Block(3800,600,'/'),
	level.Block(3800,560,'/'),
	level.Block(3800,520,'/'),
	level.Block(3800,480,'/'),
	level.Block(3800,440,'/'),
	level.Block(3800,400,'/'),
	level.Block(3800,360,'/'),
	level.Block(3800,320,'/'),
	level.Block(2840,640,'/'),
	level.Block(2840,600,'/'),
	level.Block(2840,560,'/'),
	level.Block(2840,520,'/'),
	level.Block(2840,480,'/'),
	level.Block(2840,440,'/'),
	level.Block(2840,400,'/'),
	level.Block(2840,360,'/'),
	level.Block(2840,320,'/'),
	level.Block(6680,680,'-'),
	level.Block(6680,640,'-'),
	level.Block(6680,600,'-'),
	level.Block(6680,560,'-'),
	level.Block(6680,520,'-'),
	level.Block(6680,480,'-'),
	level.Block(6680,440,'-'),
	level.Block(6680,400,'-'),
	level.Block(6680,360,'-'),
	level.Block(6680,320,'-'),
	level.Block(6680,280,'-'),
	level.Block(6680,240,'-'),
	level.Block(6680,200,'-'),
	level.Block(6680,160,'-'),
	level.Block(6680,120,'-'),
	level.Block(6680,80,'-'),
	level.Block(6680,40,'-'),
	level.Block(6680,0,'-'),
	level.Block(6680,-40,'-'),
